...
class MainComponent : public AudioAppComponent, public MidiInputCallback, public Timer {
  ...
  private:
    ...
    const Colour accentColours[5] = {Colour::fromRGB(150, 0, 0),
                                     Colour::fromRGB(0, 150, 175),
                                     Colour::fromRGB(0, 150, 175),
                                     Colour::fromRGB(0, 150, 175),
                                     Colour::fromRGB(175, 175, 175)};
    const Colour refreshButtonColours[5] = {Colour::fromRGB(0, 180, 180),
                                            Colour::fromRGB(200, 150, 0),
                                            Colour::fromRGB(200, 150, 0),
                                            Colour::fromRGB(200, 150, 0),
                                            Colour::fromRGB(175, 175, 175)};
    const Colour importButtonColours[5] = {Colour::fromRGB(127, 0, 55),
                                           Colour::fromRGB(30, 30, 30),
                                           Colour::fromRGB(30, 30, 30),
                                           Colour::fromRGB(30, 30, 30),
                                           Colour::fromRGB(127, 0, 55)};
    const Colour exportButtonColours[5] = {Colour::fromRGB(175, 175, 175),
                                           Colour::fromRGB(175, 175, 175),
                                           Colour::fromRGB(175, 175, 175),
                                           Colour::fromRGB(175, 175, 175),
                                           Colour::fromRGB(175, 175, 175)};
